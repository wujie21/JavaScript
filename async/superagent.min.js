          ...
          void 0 !== e && (e.exports = o),
            ...
            (o.prototype.emit = function (t) {
              ...
              var e = [].slice.call(arguments, 1),
                r = this._callbacks["$" + t];
              if (r)
                for (var o = 0, i = (r = r.slice(0)).length; o < i; ++o)
                  r[o].apply(this, e);
              return this;
            }),
          ...
          function y(t) {
            for (
              ...
              -1 == (i = (o = r[n]).indexOf("="))
                ...
                : (e[decodeURIComponent(o.slice(0, i))] = decodeURIComponent(
                    o.slice(i + 1)
                  ));
            return e;
          }
              ...
              this.on("end", function () {
                ...
                try {
                  ...
                  return (
                    ...
                    o.xhr
                      ? ((e.rawResponse =
                          void 0 === o.xhr.responseType
                            ? o.xhr.responseText
                            : o.xhr.response),
                        (e.status = o.xhr.status ? o.xhr.status : null),
          ...
          (c.serializeObject = f),
            ...
            (b.prototype.auth = function (t, e, r) {
              1 === arguments.length && (e = ""),
                "object" === (void 0 === e ? "undefined" : o(e)) &&
                  ...
                  ((r = e), (e = "")),
                r ||
                  (r = { type: "function" == typeof btoa ? "basic" : "auto" });
            ...
            (b.prototype._end = function () {
              ...
              if (this.hasListeners("progress"))
                try {
                  (o.onprogress = e.bind(null, "download")),
                    o.upload && (o.upload.onprogress = e.bind(null, "upload"));
                } catch (t) {}
              try {
                this.username && this.password
                  ...
                  : o.open(this.method, this.url, !0);
              } catch (t) {
                return this.callback(t);
              }
              if (
                (this._withCredentials && (o.withCredentials = !0),
                !this._formData &&
                  "GET" != this.method &&
                  "HEAD" != this.method &&
                  "string" != typeof t &&
                ...
                !n && m(i) && (n = c.serialize["application/json"]),
                  n && (t = n(t));
              }
              for (var s in this.header)
                null != this.header[s] &&
                  this.header.hasOwnProperty(s) &&
                  o.setRequestHeader(s, this.header[s]);
              this._responseType && (o.responseType = this._responseType),
                this.emit("request", this),
                o.send(void 0 !== t ? t : null);
            }),
            (c.agent = function () {
              return new h();
            }),
